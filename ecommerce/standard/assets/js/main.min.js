...
$.extend($.easing, {
  ...
  (function (t) {
    ...
    (SrInfotech.$window = t(window)),
      ...
      (SrInfotech.parseTemplate = function (t, e) {
      ...
      (SrInfotech.byTag = function (t, e) {
        return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t);
      }),
      (SrInfotech.byClass = function (t, e) {
        return e
          ? e.getElementsByClassName(t)
          : document.getElementsByClassName(t);
      }),
      (SrInfotech.setCookie = function (t, e, i) {
        var a = new Date();
        a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3),
          (document.cookie =
            t + '=' + e + ';expires=' + a.toUTCString() + ';path=/');
      }),
      (SrInfotech.getCookie = function (t) {
        for (
      ...
      (SrInfotech.$ = function (e) {
        return e instanceof jQuery ? e : t(e);
      }),
      (SrInfotech.isOnScreen = function (t) {
      ...
      (SrInfotech.appear = function (e, i, a) {
        return (
          a &&
      ...
      (SrInfotech.requestTimeout = function (t, e) {
        var i =
      ...
      (SrInfotech.requestInterval = function (t, e, i) {
        var a =
          window.requestAnimationFrame ||
          window.webkitRequestAnimationFrame ||
          window.mozRequestAnimationFrame;
      ...
      (SrInfotech.deleteTimeout = function (t) {
        if (t) {
          var e =
      ...
      (SrInfotech.initCartAction = function (e) {
        SrInfotech.$body
      ...
      (SrInfotech.initScrollTopButton = function () {
        var e = SrInfotech.byId('scroll-top');
      ...
      (SrInfotech.stickyToolboxOptions = {
        minWidth: 0,
        maxWidth: 767,
        top: !1,
        scrollMode: !0,
      }),
      (SrInfotech.stickyProductOptions = {
        minWidth: 0,
        maxWidth: 2e4,
        scrollMode: !0,
        top: !1,
      ...
      (SrInfotech.windowResized = function (e) {
        return (
          e == SrInfotech.resizeTimeStamp ||
            (void 0 === window.innerHeight &&
              (window.innerWidth =
                t(window).width() + SrInfotech.getScrollbarWidth()),
            (SrInfotech.resizeChanged =
              SrInfotech.canvasWidth != window.innerWidth),
            (SrInfotech.canvasWidth = window.innerWidth),
            (SrInfotech.resizeTimeStamp = e)),
          SrInfotech.resizeChanged
        );
      }),
      (SrInfotech.getScrollbarWidth = function () {
        if (void 0 === SrInfotech.scrollbarSize) {
          var t = document.createElement('div');
          (t.style.cssText =
            'width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;'),
            document.body.appendChild(t),
            (SrInfotech.scrollbarSize = t.offsetWidth - t.clientWidth),
            document.body.removeChild(t);
        }
        return SrInfotech.scrollbarSize;
      }),
      (SrInfotech.stickyContent = (function () {
        function e(t, e) {
          return this.init(t, e);
        }
        function i() {
          SrInfotech.$window.trigger('sticky_refresh.SrInfotech', {
            index: 0,
            offsetTop: 0,
          });
        }
        function a(t) {
          (t && !SrInfotech.windowResized(t.timeStamp)) ||
            (SrInfotech.$window.trigger('sticky_refresh_size.SrInfotech'), i());
        }
        return (
          (e.prototype.init = function (e, i) {
            (this.$el = e),
              (this.options = t.extend(
                ...
                SrInfotech.stickyDefaultOptions,
                i,
                SrInfotech.parseOptions(e.attr('data-sticky-options'))
              )),
              SrInfotech.$window
                .on('sticky_refresh.SrInfotech', this.refresh.bind(this))
                .on(
                  'sticky_refresh_size.SrInfotech',
          ...
          (e.prototype.refreshSize = function (t) {
            ...
            this.isWrap ? e || this.unwrap() : e && this.wrap(),
              (SrInfotech.sticky_top_height = 0),
                    ...
                    (this.scrollPos <= i && a.hasClass('fix-bottom'))
                      ? (a.addClass('fixed'),
                        ...
                        a.hasClass('product-sticky-content') &&
                          SrInfotech.$body.addClass('addtocart-fixed'))
                      : (a
                          .removeClass('fixed')
                          .css('margin-top', '')
                          .css('margin-bottom', ''),
                        ...
                        a.hasClass('product-sticky-content') &&
                          SrInfotech.$body.removeClass('addtocart-fixed')),
                    (this.scrollPos = i))
                  : (a.addClass('fixed'), this.onFixed && this.onFixed()),
                a.is('.fixed.fix-top')
                  ? ((e.offsetTop += a[0].offsetHeight),
                    (SrInfotech.sticky_top_height = e.offsetTop))
          ...
          SrInfotech.$window.on('wolmart_complete', function () {
            window.addEventListener('scroll', i, { passive: !0 }),
              SrInfotech.$window.on('resize', a),
              setTimeout(function () {
                a();
              }, 300);
          }),
      ...
      (SrInfotech.parallax = function (e, i) {
        t.fn.themePluginParallax &&
          SrInfotech.$(e).each(function () {
            ...
            e.themePluginParallax(
              t.extend(
                !0,
                SrInfotech.parseOptions(e.attr('data-parallax-options')),
                i
              )
            );
          });
      }),
      (SrInfotech.skrollrParallax = function () {
        SrInfotech.isMobile ||
          ('undefined' != typeof skrollr &&
            SrInfotech.$('.skrollable').length &&
            skrollr.init({ forceHeight: !1 }));
      }),
      (SrInfotech.initFloatingParallax = function () {
        t.fn.parallax &&
          SrInfotech.$('.floating-item').each(function (e) {
            var i = t(this);
            i.data('parallax') &&
              (i.parallax('disable'),
              ...
              i.parallax(SrInfotech.parseOptions(i.data('options')));
          });
      }),
      (SrInfotech.isotopeOptions = {
        itemsSelector: '.grid-item',
        layoutMode: 'masonry',
        percentPosition: !0,
        masonry: { columnWidth: '.grid-space' },
      }),
      (SrInfotech.isotopes = function (e, i) {
          ...
          SrInfotech.$(e).each(function () {
            var e = t(this),
              n = t.extend(
                ...
                {},
                a.isotopeOptions,
                SrInfotech.parseOptions(e.attr('data-grid-options')),
                i || {}
              );
            SrInfotech.lazyLoad(e),
      ...
      (SrInfotech.initNavFilter = function (e) {
        t.fn.isotope &&
          SrInfotech.$(e).on('click', function (e) {
            var i = t(this),
            ...
            t(n || '.grid')
              ...
              .isotope('on', 'arrangeComplete', function () {
                SrInfotech.$window.trigger('appear.check');
              }),
      ...
      (SrInfotech.ratingTooltip = function (t) {
        for (
          var e = SrInfotech.byClass('ratings-full', t || document.body),
            i = e.length,
            a = function () {
              var t =
      ...
      (SrInfotech.setProgressBar = function (e) {
        SrInfotech.$(e).each(function () {
          var e = t(this),
      ...
      (SrInfotech.alert = function (e) {
        SrInfotech.$body.on('click', e + ' .btn-close', function (i) {
          i.preventDefault(),
            t(this)
              .closest(e)
              .fadeOut(function () {
      ...
      (SrInfotech.closeTopNotice = function (e) {
        SrInfotech.$body.on('click', e, function (e) {
          e.preventDefault(), t('.top-banner').slideUp();
        });
      }),
      (SrInfotech.accordion = function (e) {
        SrInfotech.$body.on('click', e, function (e) {
          var a = t(this),
      ...
      (SrInfotech.appearAnimate = function (e) {
        SrInfotech.$(e).each(function () {
          var e = this;
          SrInfotech.appear(e, function () {
      ...
      (SrInfotech.countDown = function (e) {
        t.fn.countdown &&
          SrInfotech.$(e).each(function () {
            var e = t(this),
              i = e.data('until'),
      ...
      (SrInfotech.priceSlider = function (e, i) {
      ...
      (SrInfotech.stickySidebarOptions = {
        autoInit: !0,
        minWidth: 991,
      ...
      (SrInfotech.stickySidebar = function (e) {
        if (t.fn.themeSticky) {
          var i = 0;
          function a() {
            SrInfotech.$(e).trigger('recalc.pin'),
          ...
          !t('.sticky-sidebar > .filter-actions').length &&
            ...
            setTimeout(a, 300),
            SrInfotech.$window.on('click', '.tab .nav-link', function () {
              setTimeout(a);
            });
        }
      }),
      (SrInfotech.zoomImageOptions = {
        responsive: !0,
        borderSize: 0,
        zoomType: 'inner',
        onZoomIn: !0,
      ...
      (SrInfotech.zoomImageObjects = []),
      (SrInfotech.zoomImage = function (e) {
        t.fn.zoom &&
          e &&
          ('string' == typeof e ? t(e) : e).find('img').each(function () {
            var e = t(this);
            (SrInfotech.zoomImageOptions.target = e.parent()),
              (SrInfotech.zoomImageOptions.url = e.attr('data-zoom-image')),
              e.zoom(SrInfotech.zoomImageOptions),
              SrInfotech.zoomImageObjects.push(e);
          });
      }),
      (SrInfotech.zoomImageOnResize = function () {
        SrInfotech.zoomImageObjects.forEach(function (e) {
          e.each(function () {
      ...
      (SrInfotech.lazyLoad = function (t, e) {
        function i() {
        ...
        SrInfotech.$(t)
          .find('.lazy-img')
          .each(function () {
            void 0 !== e && e ? i.call(this) : SrInfotech.appear(this, i);
          });
      }),
      (SrInfotech.initPopup = function (e, i) {
        SrInfotech.$body.hasClass('home') &&
          'true' !== SrInfotech.getCookie('hideNewsletterPopup') &&
          setTimeout(function () {
            SrInfotech.popup({
              ...
              callbacks: {
                beforeClose: function () {
                  t('#hide-newsletter-popup')[0].checked &&
                    SrInfotech.setCookie('hideNewsletterPopup', !0, 7);
                },
              },
            });
          }, 7500),
          SrInfotech.$body.on('click', '.btn-iframe', function (e) {
            e.preventDefault(),
              SrInfotech.popup(
                {
                  items: {
      ...
      (SrInfotech.initNotificationAlert = function () {
        SrInfotech.$body.hasClass('has-notification') &&
          setTimeout(function () {
            SrInfotech.$body.addClass('show-notification');
          }, 5e3);
      }),
      (SrInfotech.countTo = function (e) {
        t.fn.countTo &&
          SrInfotech.$(e).each(function () {
        ...
        }),
        {
          init: function () {
            ...
            (i.className = 'minipopup-area'),
              SrInfotech.byClass('page-wrapper')[0].appendChild(i),
              (e = t(i)),
          ...
          open: function (n, l) {
            var c,
              d = this,
              p = t.extend(!0, {}, SrInfotech.minipopupOption, n);
            (c = t(SrInfotech.parseTemplate(p.template, p))),
              (d.space = p.space);
            ...
            u.length &&
              u.on('load', function () {
                (i += c[0].offsetHeight + d.space),
                  ...
                  SrInfotech.$body.on('touchstart', function () {
                    d.resume();
                  }),
                  a.push(c),
      ...
      (SrInfotech.headerToggleSearch = function (t) {
        var e = SrInfotech.$(t);
        SrInfotech.$body.on('click', '.hs-toggle .search-toggle', function (t) {
          t.preventDefault();
        }),
          'ontouchstart' in document
            ? (e.find('.search-toggle').on('click', function (t) {
              ...
              SrInfotech.$body.on('click', function (t) {
                e.removeClass('show');
              }),
      ...
      (SrInfotech.scrollTo = function (e, i) {
        var a = void 0 === i ? 0 : i;
  ...
  (function (t) {
    var e = function (t) {
        t.preventDefault(), SrInfotech.$body.addClass('mmenu-active');
      },
      i = function (t) {
        t.preventDefault(), SrInfotech.$body.removeClass('mmenu-active');
      },
      a = {
        init: function () {
          this.initMenu(),
        ...
        initMenu: function () {
          t('.menu li').each(function () {
            ...
            SrInfotech.$window.on('resize', function () {
        ...
        initCategoryMenu: function () {
          ...
          if (e.length) {
            ...
            if (e.hasClass('with-sidebar')) {
              var n = SrInfotech.byClass('sidebar');
              n.length &&
  ...
  (function (t) {
      ...
      a = function (t) {
        ...
        for (e = 0; e < a; ++e)
          if (!i[e].classList.contains('active')) {
            var n,
              o = SrInfotech.byClass('appear-animate', i[e]);
          ...
          if (
            ...
            if (
              ...
              for (var n = 0; n < i.timers.length; n++)
                SrInfotech.deleteTimeout(i.timers[n]);
              i.timers = [];
            }
    ...
    (e.defaults = { slidesPerView: 1, speed: 300 }),
        ...
        if (!c.data('slider')) {
          ...
          f.forEach(function (i) {
            ...
            t.extend(
              !0,
              g,
              SrInfotech.parseOptions(c.attr('data-swiper-options')),
              d
            ),
            i.call(this),
      ...
      (SrInfotech.slider = function (i, a = {}, n = !1) {
        SrInfotech.$(i).each(function () {
          var i = t(this);
          n
            ? new e(i, a)
      ...
      (SrInfotech.slider.pgToggle = function () {
    ...
    (e.prototype.init = function (e) {
      ...
      return (
        ...
        a.$sidebar.length &&
          ...
          a.isNavigation &&
            ((i = i.bind(this)), SrInfotech.$window.on('resize', i)),
          SrInfotech.$window.on('resize', function (t) {
            SrInfotech.windowResized(t.timeStamp) &&
              SrInfotech.$body.removeClass(e + '-active');
          }),
          a.$sidebar
          ...
          a.$sidebar
            ...
            .on('click', function (t) {
              SrInfotech.$body.removeClass(e + '-active'), t.preventDefault();
            })),
        !1
      );
    }),
  ...
  (function (t) {
    var e = {
      init: function () {
        var e;
        SrInfotech.call(SrInfotech.ratingTooltip, 500),
          SrInfotech.call(SrInfotech.setProgressBar('.progress-bar'), 500),
          this.initVariation(),
          ...
          SrInfotech.$body.on('click', '.select-menu a', function (t) {
            t.preventDefault();
          }),
          SrInfotech.$body.on('click', '.selected-item i', function (e) {
            t(e.currentTarget)
              .parent()
              .fadeOut(function () {
                var e = t(this),
          ...
          SrInfotech.$body.on('mousedown', function (e) {
            t('.select-menu').removeClass('opened');
          }),
          SrInfotech.$body.on('click', '.filter-items a', function (e) {
          ...
          (e = t('.product-popup')).length &&
            SrInfotech.$body.on('click', '.btn-quickview', function (i) {
              i.preventDefault(),
                SrInfotech.popup(
                  {
          ...
          SrInfotech.priceSlider('.filter-price-slider');
      },
                ...
                a.data('load-state', 'loading'),
                  ...
                  setTimeout(function () {
                    a.next().removeClass('loading'),
                      ...
                      SrInfotech.countDown(i.find('.product-countdown'));
                  }, 500);
                var n = parseInt(
    ...
    (e.min = 1),
      ...
      (e.prototype.startIncrease = function (t) {
        ...
        (e.value = e.$value.val()),
          ...
          (e.increaseTimer = SrInfotech.requestTimeout(function () {
            (e.speed = 1),
              (e.increaseTimer = SrInfotech.requestInterval(function () {
                e.$value.val(
                  (e.value = Math.min(
      ...
      (e.prototype.startDecrease = function (t) {
        ...
        (e.value = e.$value.val()),
          ...
          (e.decreaseTimer = SrInfotech.requestTimeout(function () {
            (e.speed = 1),
              (e.decreaseTimer = SrInfotech.requestInterval(function () {
                e.$value.val(
                  (e.value = Math.max(
                    e.value - Math.floor((e.speed *= 1.05)),
                    e.min
      ...
      (e.prototype.stop = function (t) {
        SrInfotech.deleteTimeout(this.increaseTimer),
          SrInfotech.deleteTimeout(this.decreaseTimer);
      }),
      (SrInfotech.initQtyInput = function (i) {
        SrInfotech.$(i).each(function () {
          var i = t(this);
  ...
  (function (t) {
    ...
    (e.prototype.init = function (e) {
      ...
      (o.$wrapper = e),
        ...
        (o._isPgVertical = !1),
        o.isQuickView && ((i = i.bind(this)), SrInfotech.ratingTooltip()),
        (function (t) {
          (t.$thumbs = t.$wrapper.find('.product-thumbs')),
            ...
            SrInfotech.slider(t.$thumbsWrap, {}, !0);
        })(o),
        ...
        'complete' === SrInfotech.status &&
          (SrInfotech.slider(s, {
            thumbs: { swiper: o.$thumbsWrap.data('slider') },
          }),
          SrInfotech.initQtyInput(e.find('.quantity'))),
        s.length &&
          window.addEventListener(
            'resize',
            function () {
              SrInfotech.requestTimeout(function () {
                null != s.data('slider') &&
        ...
        o.$wrapper
          ...
          .on('initialized.slider', function (e) {
            t(e.target)
              .find('.product-image')
              .zoom(SrInfotech.zoomImageOptions);
          }),
      ...
      (e.prototype.clickStickyThumbnail = function (e) {
        ...
        o.length && ((o = o.offset().top + 10), SrInfotech.scrollTo(o, 500)),
          setTimeout(function () {
      ...
      (SrInfotech.productSingle = function (i) {
        return (
          SrInfotech.$(i).each(function () {
            var i = t(this);
  ...
  (function (t) {
    function e(e) {
      ...
      if (
        ...
        if ('undefined' != typeof PhotoSwipe) {
          var c = t('.pswp')[0];
          if ('rtl' == SrInfotech.$body.attr('dir'))
          ...
          d.init(), (SrInfotech.photoSwipe = d);
        }
      }
    }
    function i(t) {
    ...
    SrInfotech.initProductSinglePage = function () {
  ...
  (function (t) {
    SrInfotech.initCodePopup = function () {
      t('.box-btn.showcode span').each(function () {
        ...
        SrInfotech.$body.on('click', '.box-btn.showcode', function () {
          var e = t(this);
          e.hasClass('enabled')
        ...
        SrInfotech.$body.on('click', '.show-code', function (e) {
          e.stopPropagation();
          var i = t(this).parent();
          if (i.hasClass('show-code-added')) {
            ...
            i[0].removeChild(a),
              ...
              SrInfotech.$body.on('click', '.code-copy a', function (e) {
                e.preventDefault(),
  ...
  (function (t) {
    ...
    (e.defaultOptions = {
      ...
      (e.prototype.init = function (a, n) {
        ...
        (o.element = a),
          (o.settings = t.extend(
            ...
            !0,
            e.defaultOptions,
            SrInfotech.parseOptions(a.attr('data-calendar-options')),
            n
          )),
          (o.today = new Date()),
          (i = i.bind(this));
      ...
      (SrInfotech.calendar = function (i, a) {
        SrInfotech.$(i).each(function () {
          var i = t(this);
          SrInfotech.call(function () {
            new e(i, a);
      ...
      (SrInfotech.initVendor = function (e) {
        var i = t(e),
      ...
      (SrInfotech.slideContent = function (e) {
        var i = t(e),
          a = i.next();
      ...
      (SrInfotech.initLoginVendor = function (e) {
        var i = t(e),
  ...
  jQuery,
  (SrInfotech.initLayout = function () {
    SrInfotech.isotopes('.grid:not(.grid-float)'),
      SrInfotech.stickySidebar('.sticky-sidebar');
  }),
  (SrInfotech.init = function () {
    SrInfotech.appearAnimate('.appear-animate'),
      SrInfotech.setTab('.nav-tabs'),
      SrInfotech.stickyContent('.sticky-header', { scrollMode: !1 }),
      SrInfotech.stickyContent('.sticky-footer', {
        minWidth: 0,
        maxWidth: 767,
        top: 150,
        hide: !0,
      ...
      SrInfotech.skrollrParallax(),
      SrInfotech.initFloatingParallax(),
      SrInfotech.menu.init(),
      SrInfotech.initScrollTopButton(),
      SrInfotech.shop.init(),
      SrInfotech.alert('.alert'),
      SrInfotech.closeTopNotice('.banner-close'),
      SrInfotech.accordion('.card-header > a'),
      SrInfotech.sidebar('sidebar'),
      SrInfotech.sidebar('right-sidebar'),
      SrInfotech.productSingle('.product-single'),
      SrInfotech.initProductSinglePage(),
      SrInfotech.initQtyInput('.quantity'),
      SrInfotech.initNavFilter('.nav-filters .nav-filter'),
      SrInfotech.calendar('.calendar-container'),
      SrInfotech.countDown('.product-countdown, .countdown'),
      SrInfotech.initPopup(),
      SrInfotech.initNotificationAlert(),
      SrInfotech.countTo('.count-to'),
      SrInfotech.initCartAction('.cart-offcanvas .cart-toggle'),
      SrInfotech.Minipopup.init(),
      SrInfotech.headerToggleSearch('.hs-toggle'),
      SrInfotech.initVendor('.store'),
      SrInfotech.slideContent('.login-toggle'),
      SrInfotech.slideContent('.coupon-toggle'),
      SrInfotech.slideContent('.checkbox-toggle'),
      SrInfotech.initLoginVendor('.user-checkbox'),
      SrInfotech.initCodePopup(),
      SrInfotech.slider('.swiper-container'),
      SrInfotech.call(SrInfotech.slider.pgToggle),
      SrInfotech.$window.on('resize', function () {
        SrInfotech.call(SrInfotech.slider.pgToggle);
      });
  }),
  ...
  (window.onload = function () {
    (SrInfotech.canvasWidth = window.innerWidth),
      (SrInfotech.resizeTimeStamp = 0),
      (SrInfotech.resizeChanged = !1),
